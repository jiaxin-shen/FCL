...
class ScouterAttention(nn.Module):
    ...
    def forward(self, inputs_pe, inputs, weight=None, things=None):
        ...
        if self.vis:
            ...
            vis(self.args.cid,slots_vis_raw, "vis", self.args.feature_size, weight, things)
        return updates, attn


def vis(cid,slots_vis_raw, loc, size, weight=None, things=None):
